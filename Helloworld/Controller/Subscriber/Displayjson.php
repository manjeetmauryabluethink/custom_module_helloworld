 ...
 */
namespace Bluethink\Helloworld\Controller\Subscriber;
 ...
 */
class Displayjson extends SubscriberController implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        if ($this->getRequest()->isPost() && $this->getRequest()->getPost('email')) {
            ...
            try {
				...
				return $resultJson->setData(['json_data' => 'Thank you for subscriber']);
